...
export function NavBar({
  ...
  const getNavPosition = (e, type, adjust) => {
    ...
    console.log(rect.top + scrollTop, rect.left + screenLeft);

    adjust
      ? setNavDropMenuPosX(absleft - 300 + e.target.offsetWidth)
      : setNavDropMenuPosX(absleft);
  ...
  return (
    <StyledNavBar svgIcon="/icons/16px/code.svg" svgUserIcon= "/icons/16px/user.svg" >
      <div id="styled-navbar-content">
        ...
        <Button text="My Awesome Button" btype="grey" />
